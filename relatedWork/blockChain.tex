...
but the same guarantee is not trivial for a digital coin without a trusted third party.
...
The third final part is the signature by the current owner of the new hash.
...
\subsubsection{Amount of transaction}
