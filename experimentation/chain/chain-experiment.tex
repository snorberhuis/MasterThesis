...
\begin{figure}[!h]
	\centerline{\includegraphics[scale=0.6]{experimentation/chain/chain.png}}
...
\centerline{\includegraphics[scale=0.5]{experimentation/chain/chain-down.eps}}
\label{fig:chain-experiment-down}
}
\subfigure[Total upload amount.]{
\centerline{\includegraphics[scale=0.5]{experimentation/chain/chain-up.eps}}
