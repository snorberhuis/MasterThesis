...
The bookkeeping system has to be scalable to be able process enough transactions and be publicily available.
...
by only allowing single operations at any time to be performed on the block
