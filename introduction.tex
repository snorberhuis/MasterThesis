...
and impossible to shut these users down.
...
and is used to exchange messages between nodes implementing MultiChain.
An improvement was added to Dispersy during the thesis.
