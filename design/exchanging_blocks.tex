...
The new parts of what is signed by Alice and Bob can be seen in Figure: \ref{fig:payload-signature-new}.
...
and the utilization of the network.
...
Signature A       & EC signature     & \multicolumn{1}{l|}{40} & Signature A       & EC signature     & 40
\end{tabular}
\caption{Block size}
